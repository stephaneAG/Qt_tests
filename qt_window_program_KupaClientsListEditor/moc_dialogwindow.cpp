...
**
** Created: Sat Dec 7 20:09:02 2013
...
static const char qt_meta_stringdata_DialogWindow[] = {
    "DialogWindow\0\0index\0mcombobox_OS_Slot(int)\0"
    "mcombobox_Kupy_Slot(int)\0acceptedSlot()\0"
    "rejectedSlot()\0reject()\0"
};
...
void DialogWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->mcombobox_OS_Slot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->mcombobox_Kupy_Slot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->acceptedSlot(); break;
        case 3: _t->rejectedSlot(); break;
